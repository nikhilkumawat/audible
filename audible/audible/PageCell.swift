...
//        textView.anchorToTop(nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor)
        ...
        lineSepratorView.anchorToTop(nil, left: leftAnchor, bottom: textView.topAnchor, right: rightAnchor)
        lineSepratorView.heightAnchor.constraint(equalToConstant: 1).isActive = true
